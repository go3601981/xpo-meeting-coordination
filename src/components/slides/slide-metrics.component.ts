      ...
      <div class="relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          @for (metric of metrics; track metric.title) {
            <div class="p-8 bg-white rounded-[32px] border border-gray-100 shadow-sm relative overflow-hidden group hover:border-blue-200 transition-all">
              ...
              <h3 class="text-lg font-bold text-gray-900 mb-2">{{ metric.title }}</h3>
              <p class="text-xs text-gray-500 leading-relaxed mb-6">{{ metric.description }}</p>
              
              <div class="pt-6 border-t border-gray-100">
                <p class="text-[10px] font-bold text-blue-600 uppercase tracking-widest mb-1">Target Outcome</p>
                <p class="text-sm font-medium text-gray-900">{{ metric.outcome }}</p>
              </div>
            </div>
          }
        </div>

        <div class="mt-10 p-8 bg-slate-900 rounded-[32px] text-white relative overflow-hidden">
