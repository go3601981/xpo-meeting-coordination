    ...
    <div class="min-h-full flex flex-col justify-center max-w-6xl mx-auto px-6 py-12 lg:py-4 relative overflow-hidden">
      ...
      <div class="relative z-10">
        <div class="mb-12 text-center">
          ...
          <h1 class="text-4xl md:text-5xl font-black text-[#1F2937] leading-tight mb-6">
            Next Steps for <br/>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div class="space-y-6">
            <h3 class="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">Immediate Actions</h3>
            <div class="space-y-4">
              @for (step of immediateSteps; track step.title) {
                <div class="flex items-start gap-4 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm hover:border-blue-200 transition-all">
                  ...
                  <div>
                    ...
                    <p class="text-[11px] text-gray-500 leading-relaxed">{{ step.description }}</p>
                  </div>
                </div>
              }
            </div>
          ...
          <div class="space-y-6">
            <h3 class="text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">Strategic Goals</h3>
            <div class="p-8 bg-slate-900 rounded-[32px] text-white relative overflow-hidden h-full">
              <div class="absolute -top-10 -right-10 w-40 h-40 bg-blue-500/10 rounded-full blur-2xl"></div>
              
              <div class="relative z-10 space-y-6">
                <p class="text-xl font-light leading-relaxed italic">
                ...
                <div class="pt-6 border-t border-white/10">
                  <button class="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl transition-colors flex items-center justify-center gap-2 shadow-lg shadow-blue-900/20">
